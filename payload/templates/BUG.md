...
- **Component:** structure
- **Status:** 🔲 Open
- **Description:** Stand up the initial directory layout and runnable shell so
  later feature tickets have somewhere to land.
- **Acceptance:** repo builds/boots; a smoke test or health check passes.
